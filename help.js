...
module.exports = {
  ...
  run: async(client, message, args) => {
    ...
    .setAuthor(`${BotName} - Help Menu`, 'https://media.discordapp.net/attachments/922145225491767346/922539704996491264/2021-12-20_18_11_11-Window.png', 'https://discord.gg/83Bt9KawBA')
